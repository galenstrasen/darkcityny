...
//------------------------------------------------------------------------------
        ...
        $options[] = array( "name" => __('Background Image','gxg_textdomain'),
                                                "desc" => __('Upload your own custom background image. Make sure no background color is selected below, as it would have priority over the background image settings and no image would get displayed','gxg_textdomain'),
...
//------------------------------------------------------------------------------
        ...
        $options[] = array( "name" => __('Enter your info for your social network accounts to display them in the footer.','gxg_textdomain'), 
        "type" => "info");
