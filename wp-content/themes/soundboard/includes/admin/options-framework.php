...
function optionsframework_add_page() {
        ...
        $bloginfo_link = get_stylesheet_directory_uri();
...
function optionsframework_load_scripts() {
        ...
        wp_enqueue_script('jqueryUI', get_template_directory_uri().'/js/jquery-ui-1.8.14.custom.min.js', array('jquery'), '1.8.14', false);
        ...
        <div id="header">
                ...
                <div id="header_right">
                        ...
                        <div class="documentation">
                                <a href="http://www.files.red-sun-design.com/soundboard/readme/readme.html"> <?php _e('Documentation', 'gxg_textdomain') ?> </a>
                        </div>
                </div>
...
function optionsframework_adminbar() {
        ...
        $wp_admin_bar->add_menu( array(
                'parent' => 'appearance',
                'id' => 'of_theme_options',
                'title' => __( 'Soundboard Options', 'gxg_textdomain' ),
