		...
		<div class="row">
			<div class="col-sm-5 col-sm-offset-1">
				<ul class="equip-list tac animation" data-animation="animation-fade-in-down">
					...
					<li>KRK Rockit 8 monitor speakers<li>
					<li>JBL EON 615 PA Speakers	<li>
					<li>Mark Bass Combo Head II w/ 2 X 10" speakers	<li>
					<li>Mark Bass 2 x 10" extension cab	<li>
					<li>Mesa Boogie Dual Rectifier 2 channel head<li>
					<li>Marshall JCM 2000 head<li>
			...
			<div class="col-sm-5">
				<ul class="equip-list tac animation" data-animation="animation-fade-in-down">
					...
					<li>Roland Phantom X6 keyboard</li>
					<li>Roland KC-100 keyboard amplifier </li>
					<li>DW Collector's Series 5 piece kit</li>
					<li>20" x 20" kick, 14" DW Edge snare, 12" rack tom</li><li> 14" and 16" floor toms</li>
					<li>DW 5000 hardware</li>
